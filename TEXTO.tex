...
Quando Moisés foi incumbido por Deus de empreender a gigantesca tarefa
...
Talmudista, codificador da \emph{Torah}, filósofo, místico, matemático,
...
Tendo ficado sem a mãe ao nascer, Maimônides se revela uma criança que
...
Ele abre mão da discussão, que é o que acontece no \emph{Talmud}, em
...
Maimônides divide o livro em duas partes. Na primeira ele estabelece os
...
Mas o ``corpus'' de sua doutrina logo começa a ser sacrificado por
...
pelos quais\\ se interpreta a Torah, ou por meio de inclusão}}
...
\chapter*{O quarto fundamento\subtitulo{Não se devem incluir nesta enumeração ordens\\ que abranjam todos os preceitos da Torah}}
...
Suas palavras, enaltecido seja Ele, ``Não adulterarás'' (Êxodo 20:14),
...
No capítulo de Pessahim os Sábios dizem: ``Abayé disse que se ele a
...
%
%45 A oferta adicional de ``Shavuot'' \emph{104}
%
%46 Levar dois pães em ``Shavuot'' \emph{104}
%
...
%
%49 O ofício de ``Yom Kipur'' \emph{104}
%
...
%
%112 O leproso deve ser reconhecível \emph{133}
%
...
%\emph{138}
%
%130 O dízimo do homem pobre \emph{138}
%
%131 A declaração do dízimo \emph{139}
%
%132 A narração ao levar as primícias \emph{139}
%
...
%
%137 Fazer soar o ``Shófar'' no décimo dia de ``Tishri'' do Ano do
%Jubileu \emph{141}
%
...
%
%162 Descansar no dia de ``Shavuot'' \emph{151}
%
%163 Descansar no dia de ``Rosh Hashaná'' \emph{151}
%
%164 Jejuar no dia de ``Yom Kipur'' \emph{151}
%
%165 Descansar no dia de ``Yom Kipur'' \emph{152}
%
...
%
%174 Obedecer ao Grande Tribunal \emph{154}
%
...
%
%216 A lei do Casamento Levirato \emph{171}
%
...
%
%225 A lei do homicídio involuntário \emph{173}
%
...
%
%\emph{233} O casamento de uma serva hebreia com seu amo ou com o filho
%dele \emph{175}
%
%234 O resgate de uma serva hebreia \emph{176}
%
%235 A lei sobre o escravo cananeu \emph{176}
%
%236 A penalidade por causar ferimentos \emph{176}
%
...
%
%245 A lei de compra e venda \emph{178}
%
...
Os Sábios dizem que este preceito também inclui a obrigação de convocar todos os descendentes de Adam\footnote{Os filhos de Adam no contexto da humanidade no seu todo.} para servi-Lo,
...
Você já sabe que a Torah prescreve que deve ser colocado pão novo a cada Shabat, juntamente com incenso, e que os ``Cohanim'' devem
...
enviareis'' (Números 5:3) e que na Guemará de Pessahim se lê: ```Sairá
...
``Pessah'' e ele se recusou a se fazer impuro por ela; os Sábios então
...
\paragraph{A oferta adicional de ``Pessah''}
...
\paragraph{A oferta adicional de ``Shabuot''}
...
\paragraph{A oferta adicional do décimo dia de ``Tishri''}
...
Como diz a Guemará\footnote{Pessahim 109:A.}: ``Um homem tem o dever de fazer
...
A Torah nos obriga a incluir nesse regozijo os pobres, os necessitados
...
\paragraph{Abater a oferta de ``Pessah''}

Por este preceito somos ordenados a sacrificar o cordeiro de ``Pessah''
...
está claramente expresso na Guemará de Pessahim que a primeira Oferta
de ``Pessah'' é obrigatória para as mulheres da mesma forma que para
...
incluídos os preceitos positivos de ``Pessah'' e da circuncisão, como
foi mencionado na introdução.

As regras detalhadas deste preceito estão expostas no Tratado Pessahim.

\paragraph{Comer a oferta de ``Pessah''}

Por este preceito somos ordenados a comer a Oferta de ``Pessah'' na
...
Se alguém perguntar: ``Por que você conta comer a Oferta de `Pessah', o
...
e comer a carne da Oferta de `Pessah' é outro?'', eu direi que é verdade
...
Oferta de ``Pessah'' também é por si só um preceito, como já foi
mencionado. Mas comer ervas amargas está colocado como dependente de
comer a Oferta de ``Pessah'', e não deve ser contado como um preceito
separado. Isto está provado pelo fato de que se deve comer a carne da
Oferta de ``Pessah'' em cumprimento ao preceito, quer haja ervas amargas
disponíveis ou não, mas não se comem ervas amargas
a não ser com a carne da Oferta de ``Pessah'', porque Ele diz,
...
referente à Oferta de `Pessah' estipula que ela deve ser comida
...
comendo-se a Oferta de ``Pessah'', assim também na falta da Oferta de
``Pessah'' a obrigação pode ser cumprida comendo-se pão ázimo e ervas
amargas, argumentando-se que uma vez que comer a Oferta de ``Pessah'' é
...
obrigação pode ser cumprida comendo-se apenas a Oferta de ``Pessah'',
então deveria concluir-se que, na falta da Oferta de ``Pessah'', a
obrigação pode ser cumprida comendo-se pão ázimo e ervas amargas. As
Escrituras dizem, a esse respeito: ``A comerão''\footnote{Ou seja, ``comerão'' a Oferta de ``Pessah''.}.

Está também escrito: ```A comerão': destas palavras deve-se concluir que
a Oferta de `Pessah' deve ser comida até a saciedade, enquanto que o pão
...
\paragraph{Abater a segunda oferta de ``Pessah''}
...
Aqui novamente se poderia objetar e perguntar: ``Por que você conta a segunda Oferta de ``Pessah'',\footnote{Como um preceito diferente.} transgredindo dessa forma a regra que você estabeleceu no Sétimo Fundamento de que uma lei pertencente a um
...
A Guemará de Pessahim diz:\footnote{Pessahim 93:A.} ``Na opinião de Rabi,
fica-se sujeito à extinção\footnote{Punição à pessoa que não abater a oferta de ``Pessah''.} por causa da primeira e fica-se sujeito
...
acordo com o Rabi'', porque na sua opinião o segundo `Pessah' não é
meramente complementar ao primeiro, e a lei segue, em todos esses casos,
o parecer do Rabi.

Este preceito não é obrigatório para as mulheres porque está explicado\footnote{No Tratado Pessahim.} que a Segunda\footnote{A Segunda Oferta de ``Pessah''.} é opcional para as mulheres.

As normas deste preceito estão explicadas na Guemará de Pessahim.

\paragraph{Comer a segunda oferta de Pessah''}

Por este preceito somos ordenados a comer a carne da segunda Oferta de
``Pessah'' na noite do décimo quinto dia de Iyar juntamente com pão
...
As normas detalhadas deste preceito também estão expostas em Pessahim.
...
\paragraph{A oferenda levada por um ``Zab''}
...
As normas deste preceito estão explicadas em Pessahim e no final de Temurá.
...
``Pessah'', ``E não fareis sobrar nada dele até a manhã; e a sobra
...
preceito negativo''. Em vários trechos de Pessahim e Macot, além de
...
Foi explicado, portanto, que, de acordo com nossa Torah, há três
...
todos menos ao `Cohen Gadol'. Por isso a Torah diz: `Em quem estiver a
...
O Sifrei diz: ```E as santidades de todo homem dele serão' (Números 5:10): as Escrituras separaram todas as Coisa Sagradas e as deram
aos `Cohanim', exceto a Ação de Graças,\footnote{Ver preceito positivo 66.} o Sacrifício de Paz, o Sacrifício de `Pessah',\footnote{Ver preceito positivo 55 e 56.} o Dízimo do Gado,\footnote{Ver preceito positivo 78.} o segundo Dízimo,\footnote{Ver preceito positivo 128.} e a colheita do quarto ano
...
A Torah expõe claramente que este dízimo deve ser levado a Jerusalém,
...
Está explicado em Pessahim que comer pão ázimo é obrigatório na primeira
noite (da festividade), e opcional depois disso.\footnote{Não é obrigatório comer-se pão ázimo nos outros dias de ``Pessah'', mas é proibido comer-se pão levedado.}

As normas desse preceito estão explicadas no Tratado Pessahim.

\paragraph{Descansar no primeiro dia de ``Pessah''}
...
\paragraph{Descansar no sétimo dia de ``Pessah''}

Por este preceito somos ordenados a descansar no sétimo dia de
``Pessah''. Ele está expresso em Suas palavras, enaltecido seja Ele,
...
dias\footnote{I. e., o primeiro e o sétimo dias de ``Pessah'', a Festa das
...
Uma mnemônica para o número de preceitos incondicionais é a seguinte: ``Sessenta são as rainhas'' (Cânticos 6:8), e o número dos não obrigatórios para as mulheres pode ser lembrado pela expressão ``Que o braço (``yad'')\ldots{} está se fortalecendo'' (Deuteronômio 32:36): a palavra ``nashim'' (mulher)
