...
para a manutenção da fé e da união do povo judeu no século \versal{XII}.
...
O \versal{RAMBAM}, sigla de Rabi Moisés ben Maimon, ou simplesmente Maimônides,
...
início do século \versal{III}, é a obra que condensa as explicações e os
...
só terminou no século \versal{V}, mas ficou rapidamente demonstrado que o povo
...
grande obra do talmudista espanhol do século \versal{XIII} Aaron Halevi, que
...
no século \versal{XII}, e a grande originalidade de Maimônides nesse trabalho foi
...
Talmud do século \versal{VII}, escrita em pergaminho, e parece que sua
...
séculos \versal{II}, \versal{III} e \versal{IV}, e onde seu antepassado, o rabino Iehuda Hanassi,
...
\textbf{O Sétimo Fundamento:} Não devemos contar as leis detalhadas de
um preceito.
...
%\chapter*{O segundo fundamento\subtitulo{Não devemos incluir nesta enumeração o que se\\ pode deduzir das escrituras por meio de qualquer\\ um dos treze princípios exegéticos, pelos quais\\ se interpreta a Torá\starr, ou por meio de inclusão}}
...
letras"-números \versal{TORAH}, que totaliza 611. Eles ouviram o `Eu sou o
...
letras"-números da palavra \versal{TORAH}, e que é isso o que Ele declarou ser a
...
%\chapter*{O quarto fundamento\subtitulo{Não se devem incluir nesta enumeração ordens\\ que abranjam todos os preceitos da Torá\starr}}
...
O autor do Halachot Gdolot\starr{} já se preocupou com relação a este
...
usada em árabe no sentido de advertência é ``\versal{LA}'' (não imperativo).
...
``\versal{MA}'', mas algumas vezes eles usam as palavras ``\versal{LA}'' ou ``\versal{LAISA}''. Por
outro lado, os hebreus negam a maioria das vezes com a mesma palavra
``\versal{LO}'', também usada para fazer uma advertência. Eles negam também com a
palavra ``\versal{AYIN}'', bem como com as formas que essa palavra adquire quando
se lhe acrescentam pronomes como sufixos, tais como ``\versal{EINO}'' (ele não
é), ``\versal{EINAM}'' (eles não são), ``\versal{EINCHEM}'' (você não é), e outras.

Encontram"-se negações em hebreu com a palavra ``\versal{LO}'' em versículos tais
como: ``E não (\versal{VE}'\versal{LO}) se levantou mais, em Israel, profeta algum como
Moisés'';\footnote{Deuteronômio 34:10.} ``Deus não (\versal{LO}) é homem, para que minta'';\footnote{Números 23:19.} ``Não (\versal{LO}) haverá desgraça duas vezes'';\footnote{Nahum 1:9.}
``E não (\versal{VE}'\versal{LO}) ficou homem com ele'';\footnote{Gênesis 45:1.} ``E ele não
(\versal{VE}'\versal{LO}) se levantou nem foi em sua direção'';\footnote{Esther 5:9.} e em muitos
outros casos como esses. Negações com a palavra ``\versal{EIN}'' aparecem, por
exemplo, nos versículos ``E homem não (\versal{AYIN}) existia'';\footnote{Gênesis 2:5.} ``Mas os mortos não (\versal{EINAM})
...
``\versal{LO}''. Assim, é importante que aquele que analisa o assunto
...
Você deve saber que todas as obrigações e advertências da Torá\starr{} se
...
Continuando este debate, disseram ali: ``Mas Rabá\starr{} diz que não se fica
...
Os Sábios explicam no início de Macot\starr{} que no caso de uma proibição cujo
...
\addcontentsline{toc}{chapter}{\textsc{a crença em deus} {[}preceitos 1 a 19{]}}
...
como está dito em `E os filhos dos profetas saíram'\,''.\footnote{Reis \versal{II}, 2:3.} O Sifrei\starr{} também diz,
...
\addcontentsline{toc}{chapter}{\textsc{o santuário} {[}preceitos 20 a 95{]}}
...
Joshuá e no livro de Samuel.\footnote{Josh. 3:14; \versal{II} Sam. 15:25.} quando Davi ordenou trazer a
...
\addcontentsline{toc}{chapter}{\textsc{a purificação} {[}preceitos 96 a 113{]}}
...
de aspersão\footnote{Números \versal{XIX}, 9--21.} a qual, sob certas circunstâncias,
...
todos explicados na Torá\starr; deve saber também que há vários textos, regulamentações e condições relativos a cada um desses preceitos expostos nos trechos Vaiehí Baiom Hashemini\starr,\footnote{Levítico \versal{IX}, 1--11; 47.} Tazriá\starr,\footnote{Levítico \versal{XII}, 1--13; 59.} Zot Tihi'ié\starr\footnote{Levítico \versal{XIV}, 1--15; 33.} e no trecho Veyikemu Eilecha para
Adoma.\footnote{Números \versal{XIX}, 1--22.}
...
\addcontentsline{toc}{chapter}{\textsc{os dízimos e as doações} {[}preceitos 114 a 152{]}}
...
\addcontentsline{toc}{chapter}{\textsc{os festivais} {[}preceitos 153 a 171{]}}
...
\addcontentsline{toc}{chapter}{\textsc{a ética do estado} {[}preceitos 172 a 193{]}}
...
\addcontentsline{toc}{chapter}{\textsc{os deveres para com os semelhantes} {[}preceitos 194 a 209{]}}
...
\addcontentsline{toc}{chapter}{\textsc{os deveres para com a família} {[}preceitos 210 a 223{]}}
...
\addcontentsline{toc}{chapter}{\textsc{a aplicação das leis criminais} {[}preceitos 224 a 231{]}}
...
\addcontentsline{toc}{chapter}{\textsc{o direito da propriedade} {[}preceitos 232 a 248{]}}
